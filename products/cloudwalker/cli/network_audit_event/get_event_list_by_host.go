...
func init() {
		GetEventListByHostCmd.Flags().StringSliceVar(&getEventListByHostParams.Cmdline, "cmdline", nil, "命令行")
		GetEventListByHostCmd.Flags().StringSliceVar(&getEventListByHostParams.Comment, "comment", nil, "用户自定义备注")
		GetEventListByHostCmd.Flags().StringSliceVar(&getEventListByHostParams.ContainerId, "container-id", nil, "容器id")
		...
		GetEventListByHostCmd.Flags().StringSliceVar(&getEventListByHostParams.Target, "target", nil, "目标地址")
		GetEventListByHostCmd.Flags().StringSliceVar(&getEventListByHostParams.Type, "type", nil, "网络异常类型")
		GetEventListByHostCmd.Flags().StringSliceVar(&getEventListByHostParams.UpdatedAt, "updated-at", nil, "更新时间")
