...
var GetListCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		err := cli.Call(context.Background(), "AssetEnvService.GetList", getListParams, &result)
		if err != nil {
...
func init() {
		...
		GetListCmd.Flags().StringSliceVar(&getListParams.Name, "name", nil, "环境变量名")
		...
		GetListCmd.Flags().StringSliceVar(&getListParams.Type, "type", nil, "环境变量类型")
		GetListCmd.Flags().StringSliceVar(&getListParams.UpdatedAt, "updated-at", nil, "更新时间")
		GetListCmd.Flags().StringSliceVar(&getListParams.Username, "username", nil, "环境变量的拥有者")
		GetListCmd.Flags().StringSliceVar(&getListParams.Value, "value", nil, "环境变量名的值")
}
...
type GetListParams struct {
	...
	Username []string `json:"username"` // 环境变量的拥有者
	Value []string `json:"value"` // 环境变量名的值
}
