...
func init() {
		...
		GetWhitelistCmd.Flags().Float64SliceVar(&getWhitelistParams.IsolateState, "isolate-state", nil, "隔离状态")
		GetWhitelistCmd.Flags().IntSliceVar(&getWhitelistParams.Level, "level", nil, "事件等级(1-低危，2-中危，3-高危，4-严重)")
		GetWhitelistCmd.Flags().StringSliceVar(&getWhitelistParams.Md5, "md5", nil, "文件 MD5")
		...
		GetWhitelistCmd.Flags().StringSliceVar(&getWhitelistParams.WebshellType, "webshell-type", nil, "Webshell 类型")
