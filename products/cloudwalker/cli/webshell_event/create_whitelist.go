...
func init() {
		...
		CreateWhitelistCmd.Flags().Float64SliceVar(&createWhitelistParams.IsolateState, "isolate-state", nil, "隔离状态")
		CreateWhitelistCmd.Flags().IntSliceVar(&createWhitelistParams.Level, "level", nil, "事件等级(1-低危，2-中危，3-高危，4-严重)")
		CreateWhitelistCmd.Flags().StringSliceVar(&createWhitelistParams.Md5, "md5", nil, "文件 MD5")
